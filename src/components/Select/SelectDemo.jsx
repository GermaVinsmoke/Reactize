    ...
    render() {
        return (
            <div>
                ...
                <a target='_blank' href='https://materializecss.com/select.html'>
                        {` Select `}
                    </a>docs</p>
                <SecondHeader
                ...
                />
                <a className="btn waves-effect waves-light purple darken-4" target="_blank" href="https://codesandbox.io/s/32pmrlk7l1">
