...
class PreselectedSelection extends Component {
    componentDidMount() {
        const options = {
            inDuration: 300,
            outDuration: 200
    ...
    render() {
        return (
            <div>
                <SecondHeader secondHeader="Preselected Selection" />
                <ul
                    ref={Collapsible => {
...
export default Collapsible;        `} />
                <Navigation align="right" link={`/collapsible/${this.props.next}`} where='Next' />
